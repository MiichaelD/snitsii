...
*/
		...
		if(useSwing)
			JOptionPane.showMessageDialog(null,"Al cerrar esta ventana, se iniciar� la busqueda\n" +
	...
	private static void checkUpdateAvailable(){
		...
		try {
            ...
            if( CURRENT_VERSION < Integer.parseInt(res)){
            	...
            	if(useSwing){
            		JOptionPane.showMessageDialog(null,"Se ha encontrado una versi�n "+
            				"mas reciente y es necesario actualizar.\n" +
            				"Puedes descargar la actualizaci�n en: http://bit.ly/15WxeUT",
        					"Busqueda de NIP",JOptionPane.WARNING_MESSAGE);
            	}
            	else{
            		System.out.println("Se ha encontrado una versi�n mas reciente y es necesario actualizar.\n" +
            				"Puedes descargar la actualizaci�n en: http://bit.ly/15WxeUT");
            	}
            	System.exit(0);
            }
